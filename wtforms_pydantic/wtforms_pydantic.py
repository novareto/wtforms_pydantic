...
def model_fields(entity: BaseModel, only=None, exclude=None, field_args=None, converter=None):
...
def model_form(entity: BaseModel, base_class=BaseForm, only=None, exclude=None, field_args=None, converter=None, submit_kwargs={}):
    field_dict = model_fields(entity, only=only, exclude=exclude, field_args=field_args, converter=converter)
